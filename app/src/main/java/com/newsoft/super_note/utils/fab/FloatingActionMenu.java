package com.newsoft.super_note.utils.fab;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private static final float OPENED_PLUS_ROTATION_LEFT = 0f;
    private static final float OPENED_PLUS_ROTATION_RIGHT = 0f;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mIcon == null) {
            mIcon = getResources().getDrawable(R.drawable.ic_pencil);
        }
